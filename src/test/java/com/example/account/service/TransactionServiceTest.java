...
class TransactionServiceTest {
    ...
    void useBalanceFailed_userNotFound() {   //유저가 없을 경우
        //given
        given(accountUserRepository.findById(anyLong()))
    ...
    void useBalanceFailed_accountNotFound() {   //계좌가 없을 경우
        //given
        AccountUser user = AccountUser.builder()
                .id(12L)
                .name("Pobi").build();
    ...
    void useBalanceFailed_userUnMatch() {   // 계좌 소유주와 아이디 다름
        //given
    ...
    @Test
    @DisplayName("트랜잭션 실패 - 잔액 사용 실패 - 내역 저장 성공")
    ...
    void cancelBalanceFailed_accountNotFound() {   //계좌가 없을 경우
        //given
        given(transactionRepository.findByTransactionId(anyString()))
    ...
    void cancelBalanceFailed_transactionAccountUnMatch() {   //계좌가 없을 경우
        //given
        AccountUser user = AccountUser.builder()
                .id(12L)
                .name("Pobi").build();
    ...
    @Test
    @DisplayName("거래금액과 취소금액 매칭 실패 - 잔액 사용 취소 실패")
    void cancelBalanceFailed_cancelMustFully() {   //계좌가 없을 경우
        //given
        AccountUser user = AccountUser.builder()
                .id(12L)
                .name("Pobi").build();
    ...
    @Test
    @DisplayName("거래금액과 취소금액 매칭 실패 - 잔액 사용 취소 실패")
    void cancelBalanceFailed_tooOldOrderToCancel() {   //계좌가 없을 경우
        //given
        AccountUser user = AccountUser.builder()
                .id(12L)
                .name("Pobi").build();
    ...
    @Test
    @DisplayName("원 사용 거래 없음 - 잔액 사용 확인 실패")
